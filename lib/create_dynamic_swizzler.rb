...
if new_structs_list.length() > 0
  ...
  structs_output.puts "// This file is auto generated by Rollout.io SDK during application build process, it should be commited to you repository as part of your code. For more info please checkout the FAQ at http://support.rollout.io
...
existing_signatures_by_chunk = file_names.map.with_index { |file, index|
  if File.size(file) > 0
    ...
    File.write(file, "// This file is auto generated by Rollout.io SDK during application build process, it should be commited to you repository as part of your code. For more info please checkout the FAQ at http://support.rollout.io
